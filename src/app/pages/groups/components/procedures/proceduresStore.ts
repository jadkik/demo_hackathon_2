...
@Injectable()
export class ProceduresStore extends UsableContentStore {
    ...
    protected onCreateComposite(new_id: string): UsableContent {
        ...
        let other = {};
        let new_content = new UsableContent('procedure', new_id, {identifiers:identifiers, timestamp:timestamp, composition:new_composition, other:other});
        return new_content;
    }
